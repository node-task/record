...
var Record = function Record(path, encoding, input) {
  this.path = path;
  // allow second argument to be a buffer
...
Record.prototype.clone = function () {
  var replace = new this.constructor(this.path, this.encoding);
  if(this.buffer !== null) {
